...
<input type='email' placeholder='Enter your valid email here'
...
/>
  ...
  <textarea name='' id='' className='w-full text-white bg-slate-900 px-6 py-4 rounded-lg border-none font-ubuntu' placeholder='Enter your message' rows='4'></textarea>
